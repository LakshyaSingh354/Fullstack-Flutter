...
const deleteTweetRepo = (tweetId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tweetBody = yield tweet_model_1.default.findOneAndDelete({ tweetId: tweetId });
        return { status: true, adminId: tweetBody === null || tweetBody === void 0 ? void 0 : tweetBody.adminId };
    }
    catch (error) {
        console.log(error);
        return { status: false, adminId: null };
    }
});
