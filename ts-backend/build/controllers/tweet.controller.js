...
const createTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (success) {
            const updateSuccess = yield (0, user_repository_1.updateUserWithTweetIdRepo)(tweet.adminId, tweet.tweetId);
            if (updateSuccess) {
                res.status(200).json({ "data": tweet });
            }
            else {
...
const updateTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const tweet = yield (0, tweet_repository_1.updateTweetRepo)(updatedTweet.tweetId, updatedTweet);
        if (tweet) {
...
const deleteTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (tweet.status) {
            const updateSuccess = yield (0, user_repository_1.updateUserWithDeleteTweetIdRepo)(tweet.adminId, tweetId);
            if (updateSuccess) {
